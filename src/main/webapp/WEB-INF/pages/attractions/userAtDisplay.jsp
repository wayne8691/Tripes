...
<script type="text/javascript">	
	...
	window.onload = function() {
		...
		xhr1.open("GET", "<c:url value='/attractions/" + key + "' />", true);
		xhr1.send();	
		xhr1.onreadystatechange = function() {
		 // 伺服器請求完成
		    if (xhr1.readyState == 4 && xhr1.status == 200) {
			   var attractionsBean = JSON.parse(xhr1.responseText);
			   div_image.style = "background-image:url("+ attractionsBean.image +");";
			   name.innerHTML = attractionsBean.name;
			   address.innerHTML = attractionsBean.address;
			   introduction.innerHTML = "&emsp;&emsp;"+ attractionsBean.introduction;
		    }
	    }
								...
								<div
									...
									<p>
										<font style="vertical-align: inherit;"> 
											<span id="introduction" style="font-size:22px;"></span>
										</font>
									</p>
									<h4 class="mb-4">
										<font style="vertical-align: inherit;"> 
											<span class="fa fa-map-marker" id="address"></span>
										</font><br>
									</h4>
									<p>
