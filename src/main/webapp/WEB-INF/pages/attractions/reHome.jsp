				    ...
				    $('#table_id').empty(""); //清空table內的資料
						if(json = null){
						    ...
						    table.append("<thead><tr align='center'>"
						    				+ "<th style='width: 3%;'>編輯</th>"
											+ "<th style='width: 3%;'>項目</th>"
											+ "<th style='width: 10%;'>餐廳名稱</th>"
									    	+ "<th style='width: 15%;'>完整地址</th>"
									    	+ "<th style='width: 10%;'>營業時間</th>" 
									    	+ "<th style='width: 5%;'>店家電話</th>"
									    	+ "<th style='width: 10%;'>美食種類</th>"				
									    	+ "<th style='width: 15%;'>照片</th>" 
									    	+ "<th style='width: 29%;'>介紹</th>" 
								    	+ "</tr></thead><tbody>");

						    $.each(parsedObjinArray,function(i,n){
								var tr = "<tr>"
								          	+" <td align='center' style='font-size:18px;'> <a href='" + attractionsEdit + n.pk + "'><i class='far fa-edit'></i></a></td>"
								            ...
								            + "<td align='center'>" +"<img src='" + n.imageRe + "'  width='200px' height='125px'>" + "</td>" 
								            + "<td>" + n.introductionRe + "</td>" 
							             + "</tr>";
							    table.append(tr);
							    j =j+1; 
						   });
						    table.append("</tbody><tfoot><tr align='center'>"
						    				+" <th>編輯</th><th>編號</th><th>餐廳名稱</th><th>完整地址</th><th>營業時間</th><th>店家電話</th><th>美食種類</th><th>照片</th><th>介紹</th>"
						    				+"</tr></tfoot>");	
					  }
				   },
				   error: function() {
