...
<style>
body{
            background-image: url('/blogstyle/img/blog/pexels-photo-1631677.jpeg');
            position: relative;
            width: 100%;
            height: 100vh;
...
<body>
<FORM ACTION="saveArticle.controller" method="post" id="from1" enctype="multipart/form-data">
	<div>
		<label class="c"> 選擇子版:</label>
		<div>
		...
		<div>
			<label for="image"> 
				<font style="vertical-align: inherit;" class="b">上傳照片:</font>
			</label>
			<input type="file" name="image" class="b"/><br>
		</div>
