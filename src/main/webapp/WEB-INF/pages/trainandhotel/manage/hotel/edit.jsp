						...
						<div class="basic-form">
							<form action=./update method="post" enctype="multipart/form-data">
								...
								<div class="basic-form">
									...
									<div class="form-group">
										<input type="text" name="name" class="form-control input-default" value="<%=hotel.getName()%>">
									</div>
									<h4 class="card-title">旅館地址:</h4>
									<div class="form-group">
										<input type="text" name="address" class="form-control input-default" value="<%=hotel.getAddress()%>">
									</div>
									<h4 class="card-title">飯店介紹</h4>
									<div class="form-group">
										<textarea class="form-control h-150px" rows="10" id="comment" name="intro"><%=hotel.getIntro()%></textarea>
									</div>
									<h4 class="card-title">飯店電話</h4>
									<div class="form-group">
										<input type="text" name="phone" class="form-control input-default"	value="<%=hotel.getPhone()%>">
									</div>
									<div class="row">
