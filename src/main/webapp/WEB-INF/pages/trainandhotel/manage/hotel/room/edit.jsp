						...
						<div class="basic-form">
							<form action=./update method="post" enctype="multipart/form-data">
								...
								<div class="basic-form">
									...
									<div class="form-group">
										<input type="text" name="name"	class="form-control input-default" value="<%=room.getName()%>">
									</div>
									<h4 class="card-title">房間人數:</h4>
									<div class="form-group">
										<input type="text" name="cap" class="form-control input-default" value="<%=room.getCapacity()%>">
									</div>
									<h4 class="card-title">房間價格</h4>
									<div class="form-group">
										<input type="number" name="price" class="form-control h-150px" value="<%=room.getPrice()%>">
									</div>
									<h4 class="card-title">房間床位</h4>
									<div class="form-group">
										<input type="number" name="bed" class="form-control h-150px" value="<%=room.getBed()%>">
									</div>
