...
List<City> cityList = request.getAttribute("cityList") != null ?(List<City>) request.getAttribute("cityList")
        : new ArrayList<>();
List<Hotel> hotelList = request.getAttribute("hotelInCityList") != null ? (List<Hotel>) request.getAttribute("hotelInCityList")
        : new ArrayList<>();
...
List<TrainStation> tsList = request.getAttribute("all") != null? (List<TrainStation>) request.getAttribute("all"):
		new ArrayList<>();
int count = 0;
City thisCity = request.getAttribute("city") !=null ?(City) request.getAttribute("city") : new City();
%>
	 ...
	 <section class="ftco-section ftco-no-pb">
	        <div class="container">
	            <div class="row">
	                ...
	                <a href ="./hotelInCity?name=<%=thisCity.getName()%>"><span style="font-size:16px;"> <%=thisCity.getName()%></span></a>
	                </div>
	            </div>
	        </div>
	   </section>
			...
			%>
				...
				<div class="col-12 col-md-4 ftco-animate">
	            	<div class=" hotel mb-2">
	                    ...
	                    <div class="card-body p-3" " style="background-color:white; width:300px; height:100px;">
