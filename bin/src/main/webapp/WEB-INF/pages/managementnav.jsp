        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="${pageContext.request.contextPath}/managememberchart.controller">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="${pageContext.request.contextPath}/managememberchart.controller">統計圖</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="${pageContext.request.contextPath}/">Back To Tripweb</a></li>
                    ...
                    <li>
                   	...
                   	<li class="nav-label">景點</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class='fas fa-tree' ></i><span class="nav-text">景點管理</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li class="nav-label">餐廳</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class='fas fa-utensils'></i><span class="nav-text">餐廳管理</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li class="nav-label">套裝行程</li>	
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class='fas fa-utensils'></i><span class="nav-text">行程管理</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="${pageContext.request.contextPath}/travelGroup.groupHome">行程管理</a></li>
                        </ul>
                    </li>
