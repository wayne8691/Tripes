						...
						if(json = null){
						    ...
						    $.each(parsedObjinArray,function(i,n){
								var tr = "<tr>"
								            ...
								            + "<td align='center'>" + n.counties + "</td>" 
								            + "<td align='center'>" + n.address + "</td>" 
								            + "<td align='center'>" +"<img src='" + n.image + "' width='250px' height='156px'>" + "</td>" 
								            + "<td align='center'>" + n.introduction + "</td>" 
							             + "</tr>";							           
							    table.append(tr);
							    j =j+1; 
						   });
						    table.append("</tbody><tfoot><tr align='center'>"
						    				+" <th>編輯</th><th>編號</th><th>景點名稱</th><th>縣市</th><th>完整地址</th><th>照片</th><th>介紹</th>"
						    				+"</tr></tfoot>");
