						...
						<div class="basic-form">
							<form action=./update method="post" enctype="multipart/form-data">
								...
								<div class="basic-form">
									...
									<div class="form-group">
										<input type="text" name="name" class="form-control input-default" value="<%=hotel.getName()%>" style="border-color:black;">
									</div>
									<h4 class="card-title">旅館地址:</h4>
									<div class="form-group">
										<input type="text" name="address" class="form-control input-default" value="<%=hotel.getAddress()%>" style="border-color:black;">
									</div>
									<h4 class="card-title">飯店介紹</h4>
									<div class="form-group">
										<textarea class="form-control h-150px" rows="10" id="comment" name="intro" style="border-color:black;"><%=hotel.getIntro()%></textarea>
									</div>
									<h4 class="card-title">飯店電話</h4>
									<div class="form-group">
										<input type="text" name="phone" class="form-control input-default"	value="<%=hotel.getPhone()%>" style="border-color:black;">
									</div>
									<div class="row">
