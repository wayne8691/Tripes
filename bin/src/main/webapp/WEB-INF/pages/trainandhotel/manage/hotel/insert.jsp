								...
								<form action=./insert method="post" enctype="multipart/form-data">
									...
									<div class="basic-form">
										<div class="form-group">
											<select class="form-control" id="sel1" name="cityId" style="border-color:black;">
												<%
										...
										<div class="form-group">
											<input type="text" name="name" class="form-control input-default" id="name" placeholder="" required style="border-color:black;">
										</div>
										<h4 class="card-title">旅館地址:</h4>
										<div class="form-group">
											<input type="text" name="address" class="form-control input-default" id="address" placeholder="" required style="border-color:black;">
										</div>
										<h4 class="card-title">飯店介紹：</h4>
										<div class="form-group">
											<textarea class="form-control h-150px" rows="6" id="comment" name="intro" style="border-color:black;"></textarea>
										</div>									
										<h4 class="card-title">飯店電話：</h4>
										<div class="form-group">
											<input type="text" name="phone"	class="form-control input-default" id="phone" placeholder="" style="border-color:black;">
										</div>
										<div class="row">
