								...
								<form action=./insert method="post" enctype="multipart/form-data">
									...
									<div class="basic-form">
										<div class="form-group">
											<select	class="form-control" id="sel1" disabled style="border-color:black;" >
												<option value="<%= hotel.getId() %>" ><%=hotel.getName() %></option>
											</select>
										</div>
										<h4 class="card-title">房間名稱:</h4>												
										<div class="form-group">
											<input type="text" name="name"class="form-control input-default" placeholder="" style="border-color:black;">
										</div>
										<h4 class="card-title">房間價格:</h4>
										<div class="form-group">
											<input type="text" name="price"class="form-control input-default" placeholder="" style="border-color:black;">
										</div>
										<h4 class="card-title">房間人數:</h4>
										<div class="form-group">
											<input type="text" name="cap" class="form-control input-default" placeholder="" style="border-color:black;">
										</div>
										<h4 class="card-title">房間床位:</h4>
										<div class="form-group">
											<input type="number" name="bed" min="1" max="5"	class="form-control input-default" placeholder="" style="border-color:black;">
										</div>
