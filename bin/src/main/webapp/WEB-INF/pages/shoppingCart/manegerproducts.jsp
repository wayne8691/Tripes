						...
						<div class="card-body">
							...
							<div class="table-responsive" id="ttt">
								<table
									...
									<tbody>
										<c:forEach begin="1"  end="${productoutsize}" var="i">
											<tr>
												...
												<td>${productout.get(i-1).getId()}</td>
												<td>${productout.get(i-1).getHotel_id().getHotel().getName()}${productAll.get(i-1).getHotel_id().getName()}</td>
												<td>${productout.get(i-1).getStarday()}</td>
												<td>${productout.get(i-1).getEndday()}</td>
												<td>${productout.get(i-1).getReason()}</td>
											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
